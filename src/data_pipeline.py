...
SHAREPOINT_URL_SITE = os.getenv('sharepoint_url_site1')
SHAREPOINT_SITE_NAME = os.getenv('sharepoint_site_name1')
SHAREPOINT_DOC_LIB = os.getenv('sharepoint_doc_library1')
...
def _get_files_and_folders(FOLDER_NAME=''):
    ...
    # print('files:', root_folder.files)
    # print('folders:', root_folder.folders)
...
def main_start():
    last_download_time = get_last_download_timestamp()
    new_files = get_file_properties(last_download_time)
